...
Converting the existing membership in place should preserve the current team, Hub Ball record, bundle ID, TestFlight setup, and other app records. The legacy Boston Baseball Hub record would become part of the converted organization account as well. Retire the obsolete standalone Yankees record separately in App Store Connect when Apple permits it.
